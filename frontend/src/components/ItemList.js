...
const ItemList = ({ onEdit, onDelete }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '20px', width: '80%', maxWidth: '610px',  background:'lightblue', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', marginTop: '40px' }}>
                <h1>RECORDS</h1>
                {error && <p>{error}</p>}
